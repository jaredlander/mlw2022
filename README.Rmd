...
Thanks for attending my sessions at [Machine Learning Week 2022](https://www.predictiveanalyticsworld.com/machinelearningweek/). This repo will hold code from both the [R Bootcamp](https://www.predictiveanalyticsworld.com/machinelearningweek/workshops/r-bootcamp/) workshop and the [Machine Learning in R](https://www.predictiveanalyticsworld.com/machinelearningweek/workshops/machine-learning-with-r/) session.
